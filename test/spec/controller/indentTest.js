...
describe('GET api/indent', function() {
  ...
  describe('send indent', function() {
    ...
    it('shoule go into next(err)', function() {

      var getIndentById =  sinon.stub();
      var next = sinon.spy();

      resMock.send = function() {
        expect(getIndentById).calledOnce;
  ...
  describe('rener indent', function() {
    ...
    it('should go into next(err) when render', function() {

      var getIndentById =  sinon.stub();
      var next = sinon.spy();

      resMock.render = function() {
        expect(next).calledOnce;
        expect(getIndentById).calledOnce;
      };
